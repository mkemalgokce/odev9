...
public:
	...
	AkilliDizi(T i); /* tek elamanlı ve eleman degeri i olan bir akilli dizi olusturur
	TEMPLATE OLACAK*/
	...
	//unsigned kacTane(T i) const; /* veri icinde i degerinden kac tane olduğunu sayar
	//TEMPLATE OLACAK*/
